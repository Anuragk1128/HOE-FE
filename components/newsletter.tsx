...
const Newsletter = () => {
  ...
  return (
    <section className="w-full bg-gray-400 text-white py-12 sm:py-16">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="w-full max-w-3xl mx-auto mb-10 sm:mb-12">
          <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row items-stretch gap-3">
            ...
            <input
              ...
              className="w-full flex-1 px-6 py-4 rounded-full sm:rounded-l-full sm:rounded-r-none text-lg text-slate-900 bg-white border-2 border-amber-400 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-all duration-200 shadow"
              required
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 text-white text-center">
          ...
          <AnimateOnScroll y={20} delay={0.06}>
          <div className="flex flex-col items-center px-2">
          ...
          <AnimateOnScroll y={20} delay={0.12}>
